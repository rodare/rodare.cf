function modalityCourse(){
          var a= document.getElementById("input").value;
              if(a==="select modality"){
          var arr=["select course"];
              }
              else {
          var arr=["select course", "Spanish", "Japanese", "English", "Piano"];
              }
         var string="";
