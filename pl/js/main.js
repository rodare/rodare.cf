...
function courseLevel(){
          var a= document.getElementById("input").value;
            ...
            var arr=["wybierz poziom","A1(入門)", "A2(N5)", "B1(N4)", "B2(N3)", "C1(N2)", "C2(N1)"];
                ...
                var arr=["wybierz poziom","A1(introductory)", "A2(basic)", "B1(intermediate)", "B2(upper-intermediate)", "C1(advanced)", "C2(very advanced)"];
                      }
              else if(a==="Pianino"){
...
else if(a==="Stacjonarny" && b==="A1(introductory)"){
...
else if(a==="Stacjonarny" && b==="A2(basic)"){
...
else if(a==="Stacjonarny" && b==="B1(intermediate)"){
...
else if(a==="Stacjonarny" && b==="B2(upper-intermediate)"){
...
else if(a==="Stacjonarny" && b==="C1(advanced)"){
...
else if(a==="Stacjonarny" && b==="C2(very advanced)"){
